...
public class Assignment1PointTest {
    ...
    public void equals_other_point_succesful() {
        assertTrue("Different objects with same attributes should be equal", one.equals((Object) same_one));
    }
    ...
    public void toString_returns_correct_format() {
        assertThat("toString should return the correct format", one.toString(), equalTo(extracted()));
    }

    @Test
    public void equals_String_failure() {
        assertFalse("Two objects of different classes should not be equal", one.equals(extracted()));
    }

	private String extracted() {
		return "<Point(" + ONE_X + ", " + ONE_Y + ")>";
	}
